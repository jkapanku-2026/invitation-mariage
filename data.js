...
const invites = {
  ...
  "annissa": { nom: "Cher Madame Annie LOMANISA" },
  ...
  "prisca": { nom: "Cher couple Prisca EKWE" },
  ...
  "grace": { nom: "Chère couple Grâce TSHIDIBI" },
  ...
  "sardo": { nom: "Cher Monsieur Sardo BAKALA" },
  "jeanpierre": { nom: "Cher Monsieur Jean Pierre MUKOLO" },
  ...
  "papy": { nom: "Cher Monsieur Papy" },
  "jeanisse": { nom: "Chère Madame Jeanisse MASEVO" },
  ...
  "bernard": { nom: "Cher Couple Bernard MBAYA"},

  //INVITES FR DONAT
  "jeremie": { nom: "Cher Couple Jérémie Foudratch"},
  "coupleben": { nom: "Cher Couple Ben MUJANGI"},
  ...
  "gedeon": { nom: "Cher Monsieur Gédéon KABANGU" },
